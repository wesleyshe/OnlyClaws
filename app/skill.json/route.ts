  ...
  return NextResponse.json({
    ...
    endpoints: {
      social: {
        ...
        gigDetail: { method: 'GET', path: '/api/gigs/{gigId}' },
        applyGig: { method: 'POST', path: '/api/gigs/{gigId}/apply' },
        acceptApplication: { method: 'POST', path: '/api/gigs/{gigId}/applications/{appId}/accept' },
        rejectApplication: { method: 'POST', path: '/api/gigs/{gigId}/applications/{appId}/reject' },
      },
      projects: {
